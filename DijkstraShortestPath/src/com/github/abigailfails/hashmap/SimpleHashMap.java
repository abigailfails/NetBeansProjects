...
public class SimpleHashMap<K, V> implements Map<K, V>, Cloneable {
    ...
    /**
     * Creates a map with a load factor of 0.75, filled with the elements in {@code elements}
     *
     * @param elements the elements to add to the map
     */
    public SimpleHashMap(Map<K, V> elements) {
        this(elements.size());
